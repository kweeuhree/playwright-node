...
var scraper = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    var scrapedStr, articles, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, scrape(url)];
            case 1:
                scrapedStr = _a.sent();
                if (scrapedStr) {
                    articles = prettify(scrapedStr);
...
var scrape = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    var browser, context, page, links;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
var prettify = function (string) {
    ...
    var articles = string.split("\n").map(function (item) {
        var _a = item.split(",-,"), title = _a[0], url = _a[1];
